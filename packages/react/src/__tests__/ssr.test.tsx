 ...
 * server path with no jsdom. Importing the components through the `@nodus/react` barrel doubles as a
...
import { Nodus, Properties, Minimap, LayersPanel, injectGlobalStyles } from '@nodus/react';
