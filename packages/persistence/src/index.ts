/**
 * @nodus-dev/persistence — trustworthy document persistence.
...
import { effect, NodusError, toCanonicalString, type Dispose, type Editor, type Snapshot } from '@nodus-dev/core';
 ...
 * Match thrown errors with `isNodusError(e)` from `@nodus-dev/core`, never `instanceof`.
 */
