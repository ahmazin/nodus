...
Freehand / sketch drawing for [Nodus](../../README.md) — a pen tool plus a `freehand` stroke node
...
[writing a plugin](../../docs/EXTENDING.md#4-plugins). Each stroke is one undoable node; points are
...
- [`docs/EXTENDING.md`](../../docs/EXTENDING.md#4-plugins) — the plugin axis and the `EngineHost` surface.
- [`@nodus/core`](../core/README.md)
