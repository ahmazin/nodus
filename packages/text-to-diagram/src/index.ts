/**
 * @nodus-dev/text-to-diagram — bridge an LLM to a Nodus diagram. You give the model `diagramTool` (an
...
import { NodusError, type NodusRecord } from '@nodus-dev/core';
import { modelToRecords, INFRA_TYPES, type InfraModel } from '@nodus-dev/preset-infra';
